cask "apiparrot" do
    version "0.2.3"
    sha256 "65a7e39a52c9e9a2bb5265ba340e1e5655b7ad02"
  
    url "https://github.com/apiparrot/apiparrot-desktop-releases/releases/download/v#{version}/API_Parrot-#{version}-universal.dmg"
    name "API Parrot"
